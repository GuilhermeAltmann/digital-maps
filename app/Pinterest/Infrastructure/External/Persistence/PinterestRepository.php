...
class PinterestRepository implements CreatePinterestRepository
{
    ...
    public function createPinterest(PinterestEntity $p): void
    {
        ...
        $this->pinterest->opened = $p->opened()?->value()->format('H:i');
        $this->pinterest->closed =  $p->closed()?->value()->format('H:i');
        $this->pinterest->save();
    }
}
